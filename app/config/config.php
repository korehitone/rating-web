...
define('BASE_URL', 'http://localhost/rating-web/public'); // buat base url atau url utama
define('BASE_URL_IMG', 'http://localhost/rating-web/app/resource/'); 
define('PROFILE_PATH', $_SERVER['DOCUMENT_ROOT'].'/rating-web/app/resource/profile/'); // buat path menyimpan gambar profile
define('MOVIE_PATH', $_SERVER['DOCUMENT_ROOT'].'/rating-web/app/resource/movie/'); // path menyimpan gambar movie
