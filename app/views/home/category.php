<main class="flex-grow-1 p-3 p-md-5">
    <form class="d-flex align-items-center mb-4" method="GET" action="<?= BASE_URL ?>/movie/category/<?= $data['cid'] ?>">
        <input
            type="search"
    ...
    <h2 class="fs-4 fw-bold mb-3"><?php if (!empty($data['category'])) : ?><?= $data['category'] ?><?php endif ?></h2>
